/* Generated by: .//gen_notw.native -n 32 -name notw_32 -compact -standalone */
	 ...
	 INT v, INT ivs, INT ovs)
{
  ...
  DK (KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0;
	 ...
	 io + ovs, MAKE_VOLATILE_STRIDE (128, is), MAKE_VOLATILE_STRIDE (128,
									 os))
      {
	E T7, T4r, T4Z, T18, T1z, T3t, T3T, T2T, Te, T1f, T50, T4s, T2W, T3u,
	  T1G;
	E T3U, Tm, T1n, T1O, T2Z, T3y, T3X, T4w, T53, Tt, T1u, T1V, T2Y, T3B,
	  T3W;
	E T4z, T52, T2t, T3L, T3O, T2K, TR, TY, T5F, T5G, T5H, T5I, T4R, T5j,
	  T2E;
	E T3P, T4W, T5k, T2N, T3M, T22, T3E, T3H, T2j, TC, TJ, T5A, T5B, T5C,
	  T5D;
	...
	{
	  E TN, T2p, T2J, T4S, TQ, T2G, T2s, T4T, TU, T2x, T2w, T4O, TX, T2z,
	    T2C;
	  E T4P;
	  {
	    E TL, TM, T2H, T2I;
	...
	{
	  E Ty, T2f, T21, T4C, TB, T1Y, T2i, T4D, TF, T28, T2b, T4I, TI, T23,
	    T26;
	  E T4J;
	  {
	    E Tw, Tx, T1Z, T20;
