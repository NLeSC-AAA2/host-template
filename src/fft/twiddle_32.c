/* Generated by: ./gen_twiddle.native -n 32 -name twiddle_32 -compact -standalone */
...
twiddle_32 (R * ri, R * ii, __constant R * W, stride rs, INT mb, INT me, INT ms)
{
  ...
  DK (KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 62); m < me;
	 ...
	 W + 62, MAKE_VOLATILE_STRIDE (64, rs))
      {
	E Tj, T5F, T7C, T7Q, T35, T4T, T78, T7m, T1Q, T61, T5Y, T6J, T3K, T59,
	  T41;
	E T56, T2B, T67, T6e, T6O, T4b, T5d, T4s, T5g, TG, T7l, T5I, T73, T3a,
	  T4U;
	E T3f, T4V, T14, T5N, T5M, T6E, T3m, T4Y, T3r, T4Z, T1r, T5P, T5S,
	  T6F, T3x;
	E T51, T3C, T52, T2d, T5Z, T64, T6K, T3V, T57, T44, T5a, T2Y, T6f,
	  T6a, T6P;
	E T4m, T5h, T4v, T5e;
	{
	...
	{
	  E T5J, T7n, T7t, T6n, T5U, T7k, T6x, T6B, T6q, T7s, T66, T6k, T6u,
	    T6A, T6h;
	  E T6l;
	  {
	    E T5O, T5T, T60, T65;
	...
	{
	  E T3h, T4D, T7R, T7X, T3E, T7O, T4N, T4R, T46, T4A, T4G, T7W, T4K,
	    T4Q, T4x;
	  E T4B, T3g, T7P;
	...
	{
	  E T4X, T5p, T7D, T7J, T54, T7y, T5z, T5D, T5c, T5m, T5s, T7I, T5w,
	    T5C, T5j;
	  E T5n, T4W, T7z;
